    ...
    <div className='bg-white border-b'>
      ...
      <div className='p-4'>
        ...
        <div className='text-[14px] mt-1 flex flex-col gap-0.5'>
          <p className='leading-relaxed whitespace-pre-wrap line-clamp-3'>{AppConfig.introduction}</p>
          <div className='text-primary font-medium text-[12px] cursor-pointer mt-2'>More info</div>
        </div>
      </div>
    </div>
  )
