      ...
      <div className='flex flex-col md:flex-row md:h-full'>
        <div className='h-[80vh] md:h-full w-full md:w-[40%] relative' style={{}}>
          ...
          <div
            ...
            style={{ backgroundImage: `url('${AppConfig.verticalAvatar}')` }}
          />
          <div className='absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white/90 to-transparent h-full w-full text-black p-4 z-10'>
            <div className='absolute bottom-0 left-0 right-0 p-8 flex flex-col items-center'>
              <div className='text-black font-medium text-center mb-4'>Make it real.</div>
              <div className='text-black font-black text-4xl text-center'>Can we talk about your idea?</div>
              <a
